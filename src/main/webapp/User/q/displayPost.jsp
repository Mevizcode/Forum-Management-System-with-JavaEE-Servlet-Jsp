                            ...
                            <div class="col-lg-12 mb-4">
                                <div class="card" id="question-card">
                                    <div class="row px-3">
                                        ...
                                        <c:forEach items="${requestScope.getPost}" var="showPosts">
                                        ...
                                        <div class="col-md-10">
                                            <div class="card-body">
                                                <a href="#" class="card-link link-pink"><h4
                                                        class="">${showPosts.title}
                                                </h4></a>
                                                <blockquote
                                                        class="blockquote font-size-16 mb-0 card-text">${showPosts.content}
                                                </blockquote>
                                                <footer class="blockquote-footer m-0 card-text text-muted">posted by
                                                    <cite class="text-primary ">${showPosts.postedBy}</cite>
                                                    on ${showPosts.createdOn}
                                                </footer>
                                            </div>
                                        </div>
                                        </c:forEach>
...
<%--                                                <c:forEach items="${requestScope.getPost}" var="newPost">--%>
<%--                                                <form method="post"--%>
<%--                                                      action="${pageContext.request.contextPath}/threadServlet?id=${newPost.postId}">--%>
<%--                                                    <input type="hidden" name="username" value="${newPost.postedBy}">--%>
<%--                                                    <input type="hidden" name="postId"--%>
<%--                                                           value="${newPost.postId}">--%>
<%--                                                    <div class="form-group mb-3 row mt-3 pt-1">--%>
<%--                                                        <div class="form-group mb-5 row">--%>
<%--                                                            <h6 class="h6 text-muted">Your Answer</h6>--%>
<%--                                                            <textarea id="elm1" name="area"--%>
<%--                                                                      placeholder="Comment your answer here ....." minlength="15"  ></textarea> <!--onchange="checkParam1(this);" -->--%>
<%--                                                        </div>--%>
<%--                                                    </div>--%>
<%--                                                    <div class="form-group mb-3 text-center row mt-3 pt-1">--%>
<%--                                                        <div class="col-12">--%>
<%--                                                            <button class="btn btn-info w-50 waves-effect waves-light" id="btn_submit" type="submit">submit your answer--%>
<%--                                                            </button>--%>
<%--                                                        </div>--%>
<%--                                                    </div>--%>
<%--                                                </form>--%>
...
<%--    function checkParam1(inputField) {--%>
