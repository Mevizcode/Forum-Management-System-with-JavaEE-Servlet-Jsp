    ...
    <div class="main-content">
        <div class="page-content mt-5 pt-1">
            <div class="container-fluid">
                <%
                    ResultSet listMyPost = (ResultSet) request.getAttribute("myPost");
                %>
                                        ...
                                        <div class="col-md-10">
                                            <div class="card-body">
                                                <a href="#" class="card-link link-pink"><h4
                                                        class=""><%=listMyPost.getString("title")%>
                                                </h4></a>
                                                <blockquote
                                                        class="blockquote font-size-16 mb-0 card-text"><%=listMyPost.getString("content")%>
                                                </blockquote>
                                                <footer class="blockquote-footer m-0 card-text text-muted">posted by
                                                    <cite class="text-primary "><%=listMyPost.getString("postedBy")%></cite>
                                                    on <%=listMyPost.getTimestamp("createdOn")%>
                                                </footer>
                                            </div>
                                        </div>
                                        <%
