    ...
    <div class="container-fluid p-0">
        <div class="card">
            <div class="card-body">
                ...
                <div class="p-3">
                    <form class="form-horizontal mt-3" method="post" action="${pageContext.request.contextPath}/emailVerifyHandler" onkeyup="return verifyInput();">

                        <div class="alert alert-info alert-dismissible fade show" role="alert">
                            Enter Your <strong>E-mail</strong> to continue!
                        ...
                        <div class="form-group pb-2 text-center row mt-3">
                            <div class="col-12">
                                <button class="btn btn-info w-100 waves-effect waves-light" id="btnVerifyEmail" type="submit" disabled>Next</button>
                            </div>
