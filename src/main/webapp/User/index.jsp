...
<head>
    ...
    <!-- DataTables -->
    <link href="<%=basePath%>assets/libs/datatables.net-bs4/css/dataTables.bootstrap4.min.css" rel="stylesheet"
          type="text/css"/>

    <!-- Responsive datatable examples -->
    <link href="<%=basePath%>assets/libs/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css"
          rel="stylesheet"
          type="text/css"/>
...
<body data-topbar="dark" data-sidebar="dark" data-appStyle="dark" onload="toastr.success('Login Successful')">
            ...
            <div class="d-flex">
                ...
                <div class="d-none d-lg-inline-block ms-1">
                    <button type="submit" class="btn header-item noti-icon waves-effect">
                        <a href="${pageContext.request.contextPath}/User/login.jsp" class=" font-size-18 text-white">Login</a>
                    </button>
                </div>

                <div class="d-none d-lg-inline-block ms-1">
                    <button type="submit" class="btn header-item noti-icon waves-effect">
                        <a href="${pageContext.request.contextPath}/User/register.jsp" class=" font-size-18 text-white">Sign
                            up</a>
                    </button>
                </div>
                ...
                <div class="dropdown d-inline-block user-dropdown">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                        ...
                        <img class="rounded-circle header-profile-user"
                             src="<%=basePath%>assets/images/users/avatar.jpg"
                             alt="Header Avatar">
        ...
        <div data-simplebar class="h-100">
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/UserServlet" class="waves-effect active">
                ...
                <div class="row row-cols-2">
                    <div class="col mb-5">
                        <div class="btn-group " role="group" aria-label="Basic outlined example">
                            <button type="button" class="btn btn-outline-primary btn-group-sm ">Recently Posted</button>
                            <button type="button" class="btn btn-outline-primary btn-group-sm ">Most Viewed</button>
                            <button type="button" class="btn btn-outline-primary btn-group-sm ">Most Likes</button>
                            <button type="button" class="btn btn-outline-primary btn-group-sm ">Answered</button>
                            <button type="button" class="btn btn-outline-primary btn-group-sm ">Unanswered</button>
                        </div>
                    </div>
                   <!-- <div class="col mb-5">
                        <input type="text" class="form-control" placeholder="Have a question?" readonly>
                    </div>-->
                    <div class="col mb-5">
                        <form method="post" action="${pageContext.request.contextPath}/AskQuestionServlet">
                ...
                <div class="row d-flex">
                    <div class="col-xl-8">
                        <div class="row d-lg-inline-block">
                            <c:forEach items="${applicationScope.postsList}" var="listPosts">
                                <div class="col-lg-12 mb-4">
                                    <div class="card" id="question-card">
                                        <div class="row px-3">
                                            <div class="col-md-1" id="info">
                                                <a href="q/ans.jsp">
                                                    <div class="mt-3 d-inline-flex d-flex"
                                                         style="align-items: flex-start;">
                                                        <img src="<%=basePath%>assets/images/users/pp.jpg"
                                                             alt="pp"
                                            ...
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    <a href="${pageContext.request.contextPath}/listThread?id=${listPosts.postId}"
                                                       class="card-link link-pink"><h4>${listPosts.title}</h4>
                                                    </a>
                                                    <blockquote
                                                            class="blockquote font-size-16 mb-0 card-text">${listPosts.content}</blockquote>
                                                    <footer class="blockquote-footer m-0 card-text text-muted">posted by
                                                        <cite class="text-primary">${listPosts.postedBy} </cite>
                                                        on ${listPosts.createdOn}</footer>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-4">
                        <div class="row d-lg-inline-block ms-4">
                            <h6 class="h6 mt-5">Recent Posts</h6>
                            <c:forEach items="${requestScope.listPostByTitle}" var="postByTitle">
                                <div class="col-md-10 mb-4">
                                    <blockquote class="blockquote d-block w-100 font-size-16 mb-1 card-link page-link">
                                        <a href="#">${postByTitle.title}</a>
                                    </blockquote>
                                </div>
                            </c:forEach>
...
<div class="right-bar">
    <div data-simplebar class="h-100">
        ...
        <div class="p-4">
            <div class="mb-2">
                <img src="<%=basePath%>assets/images/layouts/layout-1.jpg" class="img-fluid img-thumbnail"
                     alt="layout-1">
            </div>
            ...
            <div class="mb-2">
                <img src="<%=basePath%>assets/images/layouts/layout-2.jpg" class="img-fluid img-thumbnail"
                     alt="layout-2">
            </div>
            <div class="form-check form-switch mb-3">
                <input class="form-check-input theme-choice" type="checkbox" id="dark-mode-switch"
                       data-bsStyle="<%=basePath%>assets/css/bootstrap-dark.min.css"
                       data-appStyle="<%=basePath%>assets/css/app-dark.min.css">
                <label class="form-check-label" for="dark-mode-switch">Dark Mode</label>
            </div>

            <div class="mb-2">
                <img src="<%=basePath%>assets/images/layouts/layout-3.jpg" class="img-fluid img-thumbnail"
                     alt="layout-3">
            </div>
